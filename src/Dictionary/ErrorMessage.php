...
final class ErrorMessage
{
    ...
    public const MEDIA_TYPE_REQUIRED = 'The Content-Type header must be provided and cannot be empty; check the Accept response header for supported media types.';
    ...
    public const QUERY_PARAM_REQUIRED = 'The query parameter {{ param_name }} must be provided.';
    public const INVALID_QUERY_PARAM = 'The query parameter {{ param_name }} is invalid.';
    public const HEADER_REQUIRED = 'The header {{ header_name }} must be provided.';
    public const INVALID_HEADER = 'The header {{ header_name }} is invalid.';
    public const COOKIE_REQUIRED = 'The cookie {{ cookie_name }} must be provided.';
