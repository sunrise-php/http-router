...
return [
    ...
    ErrorMessage::UNSUPPORTED_MEDIA_TYPE => 'O tipo de mídia da solicitação não é suportado para este recurso.',
    ErrorMessage::INVALID_VARIABLE => 'O valor da variável {{{ variable_name }}} no URI da solicitação \"{{ route_uri }}\" é inválido.',
    ErrorMessage::INVALID_QUERY => 'Os parâmetros de consulta da solicitação são inválidos.',
