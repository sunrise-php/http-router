...
return [
    ErrorMessage::MALFORMED_URI => 'URI-ul cererii este format incorect și nu poate fi acceptat de server.',
    ...
    ErrorMessage::UNSUPPORTED_MEDIA_TYPE => 'Tipul de media al cererii nu este suportat pentru această resursă.',
    ...
    ErrorMessage::MISSING_HEADER => 'Antetul cererii \"{{ header_name }}\" lipsește.',
    ErrorMessage::INVALID_HEADER => 'Antetul cererii \"{{ header_name }}\" este invalid.',
