...
return [
    ErrorMessage::MALFORMED_URI => '요청 URI가 잘못되어 서버에서 수락할 수 없습니다.',
    ErrorMessage::RESOURCE_NOT_FOUND => '이 URI에 대한 요청된 리소스를 찾을 수 없습니다.',
    ErrorMessage::METHOD_NOT_ALLOWED => '이 리소스에 대해 요청된 메서드는 허용되지 않습니다.',
    ErrorMessage::MISSING_MEDIA_TYPE => '요청 미디어 타입이 누락되었습니다.',
    ErrorMessage::UNSUPPORTED_MEDIA_TYPE => '이 리소스에서 지원되지 않는 요청 미디어 타입입니다.',
    ErrorMessage::INVALID_VARIABLE => '요청 URI "{{ route_uri }}"에서 변수 {{{ variable_name }}}의 값이 유효하지 않습니다.',
    ...
    ErrorMessage::INTERNAL_SERVER_ERROR => '문제가 발생하였습니다.',
];
