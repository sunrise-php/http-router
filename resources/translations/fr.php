...
return [
    ErrorMessage::MALFORMED_URI => 'L\'URI de la requête est mal formée et ne peut être acceptée par le serveur.',
    ...
    ErrorMessage::UNSUPPORTED_MEDIA_TYPE => 'Le type de média de la requête n\'est pas supporté pour cette ressource.',
    ErrorMessage::INVALID_VARIABLE => 'La valeur de la variable {{{ variable_name }}} dans l\'URI de la requête \"{{ route_uri }}\" est invalide.',
    ErrorMessage::INVALID_QUERY => 'Les paramètres de requête sont invalides.',
    ErrorMessage::MISSING_HEADER => 'L\'en-tête \"{{ header_name }}\" est manquant dans la requête.',
    ErrorMessage::INVALID_HEADER => 'L\'en-tête \"{{ header_name }}\" est invalide.',
    ...
    ErrorMessage::INTERNAL_SERVER_ERROR => 'Quelque chose s\'est mal passé.',
];
