...
return [
    ErrorMessage::MALFORMED_URI => 'URI permintaan rosak dan tidak dapat diterima oleh pelayan.',
    ErrorMessage::RESOURCE_NOT_FOUND => 'Sumber yang diminta tidak dijumpai untuk URI ini.',
    ...
    ErrorMessage::INVALID_QUERY => 'Parameter permintaan tidak sah.',
    ...
    ErrorMessage::INTERNAL_SERVER_ERROR => 'Terdapat masalah.',
];
