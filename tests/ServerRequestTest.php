...
final class ServerRequestTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        self::assertSame($serverRequest, ServerRequest::create($serverRequest));
    }
    ...
    public function testHasRouteFalse(): void
    {
        ...
        self::assertFalse(ServerRequest::create($this->mockedRequest)->hasRoute());
    }
    ...
    public function testHasRouteTrue(): void
    {
        ...
        self::assertTrue(ServerRequest::create($this->mockedRequest)->hasRoute());
    }

    public function testGetRouteInstance(): void
    {
        $this->mockedRequest->expects(self::once())->method('getAttribute')->with(RouteInterface::class)->willReturn($this->mockedRoute);
        self::assertSame($this->mockedRoute, ServerRequest::create($this->mockedRequest)->getRoute());
    }
    ...
    public function testGetClientProducedMediaType(string $requestContentTypeHeader, ?string $expectedMediaTypeIdentifier): void
    {
        ...
        self::assertSame($expectedMediaTypeIdentifier, ServerRequest::create($this->mockedRequest)->getClientProducedMediaType()?->getIdentifier());
    }
    ...
    public function testGetClientConsumedMediaTypes(string $requestAcceptHeader, array $expectedMediaTypeIdentifiers): void
    {
        ...
        self::assertSame($expectedMediaTypeIdentifiers, array_map($mediaTypeStringifier, [...ServerRequest::create($this->mockedRequest)->getClientConsumedMediaTypes()]));
    }
    ...
    public function testGetClientPreferredMediaType(string $requestAcceptHeader, array $serverProducedMediaTypeIdentifiers, ?string $expectedMediaTypeIdentifier): void
    {
        ...
        self::assertSame($expectedMediaTypeIdentifier, ServerRequest::create($this->mockedRequest)->getClientPreferredMediaType(...array_map($this->mockMediaType(...), $serverProducedMediaTypeIdentifiers))?->getIdentifier());
    }
    ...
    public function testServerConsumesMediaType(string $clientProducedMediaTypeIdentifier, array $serverConsumedMediaTypeIdentifiers, bool $expectedResult): void
    {
        ...
        self::assertSame($expectedResult, ServerRequest::create($this->mockedRequest)->serverConsumesMediaType($this->mockMediaType($clientProducedMediaTypeIdentifier)));
    }
    ...
    public function testGetClientConsumedLocales(string $requestAcceptLanguageHeader, array $expectedLocaleCodes): void
    {
        ...
        self::assertSame($expectedLocaleCodes, array_map($localeStringifier, [...ServerRequest::create($this->mockedRequest)->getClientConsumedLocales()]));
    }
    ...
    public function testGetClientPreferredLanguage(string $requestAcceptLanguageHeader, array $serverProducedLanguageCodes, ?string $expectedLanguageCode): void
    {
        ...
        self::assertSame($expectedLanguageCode, ServerRequest::create($this->mockedRequest)->getClientPreferredLanguage(...array_map($this->mockLanguage(...), $serverProducedLanguageCodes))?->getCode());
    }
    ...
    public function testGetBody(): void
    {
        ...
        self::assertSame($body, ServerRequest::create($this->mockedRequest)->getBody());
    }

    public function testGetMethod(): void
    {
        $this->mockedRequest->expects(self::once())->method('getMethod')->willReturn('GET');
        self::assertSame('GET', ServerRequest::create($this->mockedRequest)->getMethod());
    }
    ...
    public function testGetUploadedFiles(): void
    {
        ...
        self::assertSame(['foo' => $uploadedFile], ServerRequest::create($this->mockedRequest)->getUploadedFiles());
    }

    public function testGetParsedBody(): void
    {
        $this->mockedRequest->expects(self::once())->method('getParsedBody')->willReturn(['foo' => 'bar']);
        self::assertSame(['foo' => 'bar'], ServerRequest::create($this->mockedRequest)->getParsedBody());
    }

    public function testGetAttributes(): void
    {
        $this->mockedRequest->expects(self::once())->method('getAttributes')->willReturn(['foo' => 'bar']);
        self::assertSame(['foo' => 'bar'], ServerRequest::create($this->mockedRequest)->getAttributes());
    }

    public function testGetAttribute(): void
    {
        $this->mockedRequest->expects(self::once())->method('getAttribute')->with('foo', 'bar')->willReturn('bar');
        self::assertSame('bar', ServerRequest::create($this->mockedRequest)->getAttribute('foo', 'bar'));
    }
    ...
    public function testWithProtocolVersion(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withProtocolVersion('1.1'));
    }
    ...
    public function testWithHeader(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withHeader('x-foo', 'bar'));
    }
    ...
    public function testWithAddedHeader(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withAddedHeader('x-foo', 'bar'));
    }
    ...
    public function testWithoutHeader(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withoutHeader('x-foo'));
    }
    ...
    public function testWithBody(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withBody($body));
    }
    ...
    public function testWithMethod(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withMethod('GET'));
    }
    ...
    public function testWithUri(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withUri($uri));
    }
    ...
    public function testWithRequestTarget(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withRequestTarget('/'));
    }
    ...
    public function testWithQueryParams(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withQueryParams(['foo' => 'bar']));
    }
    ...
    public function testWithCookieParams(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withCookieParams(['foo' => 'bar']));
    }
    ...
    public function testWithUploadedFiles(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withUploadedFiles(['foo' => $uploadFile]));
    }
    ...
    public function testWithParsedBody(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withParsedBody(['foo' => 'bar']));
    }
    ...
    public function testWithAttribute(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withAttribute('foo', 'bar'));
    }
    ...
    public function testWithoutAttribute(): void
    {
        ...
        $serverRequest = ServerRequest::create($this->mockedRequest);
        self::assertNotSame($serverRequest, $serverRequest->withoutAttribute('foo'));
    }
}
